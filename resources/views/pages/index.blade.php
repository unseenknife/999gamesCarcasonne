...
@section('content')
    <div class="text-center"><h1>NK Carcassonne</h1>
        <p><img src="{{ asset('img/index.png') }}">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.
            ...
            Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui.</p>
        <p>Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing
            ...
            ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. </p>
        <div>
            <a class='btn btn-primary' href='{{ route('register') }}'> Inschrijven </a>
        </div>
        <p>Etiam sit amet orci
